// Creative prompt variants — subject-driven split (one self-contained const per input case).
// - PRODUCT_ONLY_CREATIVE_PROMPT: product image only. Zero person language (anchors, notes, examples).
  ...
  <prompt_authoring_protocol>
    ...
    <unit_2_ratio_aware_caption_engineering>
      **UNIT 2: RATIO-AWARE CAPTION ENGINEERING — SAME SOUL, DIFFERENT BODY**
      ...
      "[Product anchor (identical across ratios — exactly 'the product' verbatim, same pose)] + [Background+Lighting clause (IDENTICAL across all ratios — same material, same hue, same light physics word-for-word: e.g., 'pale stone plinth and sand-toned plaster under soft golden rim light')] + [Composition/Framing clause (VARIES per ratio — ratio token + negative space + framing cue)]"
      ...
      - MUST preserve product identity phrase — keep "the product" as anchor WITHOUT altering product pose/angle (identical across ratios — only framing position changes, not product pose).
...
<developer_instruction>
  ...
  <prompt_authoring_protocol>
    ...
    <unit_2_ratio_aware_caption_engineering>
      **UNIT 2: RATIO-AWARE CAPTION ENGINEERING — SAME SOUL, DIFFERENT BODY**
      ...
      Canvas Physics (NON-NEGOTIABLE):
      - **9_16 (Vertical, 1080x1920)**: Vertical gravity. Emphasize top-to-bottom flow. Subject in upper 35-40% or lower 30% (never dead center unless framing=centered). Reserve a 55-60% vertical negative strip for headline stack. Think: thumb zone, one-handed scroll. Vertical leading lines (doorway, shelf, horizon stacked). Language cue: "vertical", "towering", "stacked", "upper third", "lower breathing room".
      - **1_1 (Square, 1080x1080)**: Radial symmetry. Center-weighted or quadrant tension. Equal margins (8-12%). Instagram grid logic — must read as thumbnail at 120px. Center or tight_crop bias. Language cue: "centered", "symmetrical", "quadrant", "framed centrally".
      ...
      Examples of GOOD (do this):
      - "The person in soft morning warmth on a vertical 9_16 canvas, glowing skin against warm linen calm, gentle studio window light feathering across the face, serene minimal stillness."
  ...
  <few_shot_examples>
    Example 1 — hero_shot / studio_soft / warm / centered / minimal_modern | ratios [9_16, 1_1] | seed 51783 | cta true | person_note "glowing skin, morning light" | brand_palette null
    {
...
<developer_instruction>
  ...
  <prompt_authoring_protocol>
    ...
    <unit_2_ratio_aware_caption_engineering>
      **UNIT 2: RATIO-AWARE CAPTION ENGINEERING — SAME SOUL, DIFFERENT BODY**
      ...
      Canvas Physics (NON-NEGOTIABLE):
      - **9_16 (Vertical, 1080x1920)**: Vertical gravity. Emphasize top-to-bottom flow. Subjects in upper 35-40% or lower 30% (never dead center unless framing=centered). Reserve a 55-60% vertical negative strip for headline stack. Think: thumb zone, one-handed scroll. Vertical leading lines (doorway, shelf, horizon stacked). Language cue: "vertical", "towering", "stacked", "upper third", "lower breathing room".
      - **1_1 (Square, 1080x1080)**: Radial symmetry. Center-weighted or quadrant tension. Equal margins (8-12%). Instagram grid logic — must read as thumbnail at 120px. Center or tight_crop bias. Language cue: "centered", "symmetrical", "quadrant", "framed centrally".
  ...
  <few_shot_examples>
    Example 1 — lifestyle_shot / studio_soft / warm / centered / minimal_modern | ratios [4_5] | seed 60217 | cta true | product_note "oat linen blazer, relaxed tailoring" + person image attached | brand_palette null
    {
